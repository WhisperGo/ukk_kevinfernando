    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" id="printFormAwalAkhir" action="<?= base_url('pengembalian/export') ?>">
        ...
        <div class="col-sm-12 col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" id="printFormTanggal" action="<?= base_url('pengembalian/export') ?>">
                        <div class="form-group">
...
<script>
    function setAction(action) {
        if (action === 'windows' || action === 'excel' || action === 'pdf') {
            ...
            document.getElementById("printFormAwalAkhir").action = "<?= base_url('pengembalian/export') ?>_" + action;
            ...
            document.getElementById("printFormTanggal").action = "<?= base_url('pengembalian/export') ?>_" + action;
        }
    }
</script>
